...
<div class="wrap">
	...
	<div id="shb-dashboard-tile" class="status-<?php echo esc_attr( $status_class ); ?>">
		...
		<a class="button button-primary" href="#shb-wizard">
			<?php esc_html_e( 'Run 60‑second Wizard', 'shb' ); ?>
		</a>
	</div>

	<!-- Wizard modal -->
	<div id="shb-wizard" class="shb-modal" style="display:none;">
		<div class="shb-modal-content" role="dialog" aria-modal="true" aria-labelledby="shb-wizard-title">
			<span class="shb-close" aria-label="<?php esc_attr_e( 'Close', 'shb' ); ?>">&times;</span>
			<h2 id="shb-wizard-title"><?php esc_html_e( 'Security Headers Wizard', 'shb' ); ?></h2>
			<ol>
